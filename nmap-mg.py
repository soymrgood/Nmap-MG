...
# CONDICIONAL NUMERO 10
	...
	print (Fore.WHITE + Style.BRIGHT + "\n(1)" + Style.RESET_ALL + Fore.CYAN + Style.BRIGHT + " ->" + Style.RESET_ALL + Fore.YELLOW + Style.BRIGHT + " Crear nuevo archivo (NO disponible)" + Style.RESET_ALL)
	
	print (Fore.WHITE + Style.BRIGHT + "(2)" + Style.RESET_ALL + Fore.CYAN + Style.BRIGHT + " ->" + Style.RESET_ALL + Fore.YELLOW + Style.BRIGHT + " Usar archivo existente" + Style.RESET_ALL)

	new_option = int(input(Fore.WHITE + Style.BRIGHT + "\n>> " + Style.RESET_ALL))
	
	if new_option == 1:
		print("NO disponible :c")
	elif new_option == 2:
		print(Fore.RED + Style.BRIGHT + "\nMueve el archivo dentro del directorio de la herramienta Nmap-MG" + Style.RESET_ALL)
	
	print(Fore.WHITE + Style.BRIGHT + "\nIntroduce el nombre del archivo para reconocerlo " + Style.RESET_ALL)
